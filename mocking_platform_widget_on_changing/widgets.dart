...
class _PressableCardState extends State<PressableCard>
  ...
  void initState() {
    ...
    elevationAnimation =
        controller.drive(CurveTween(curve: Curves.easeInOutCubic)); // Tween:: resizing when we click.
    super.initState();
  }
            ...
            return Transform.scale(
              ...
              child: Padding(
                ...
                child: PhysicalModel(
                  ...
                  borderRadius: BorderRadius.circular(12 * flatten), // round
...
class HeroAnimatingSongCard extends StatelessWidget {
  ...
  double get playButtonSize => 50 + 50 * heroAnimation.value; // size-dynamic
